                        ...
                        <div class="col s12">
                            <div class="card">
                                <div class="card-content">
                                    ...
                                    <div class="row">
                                        <form action="{{ route('mahasiswalulusdo.store') }}" method="POST"
                                            ...
                                            @foreach ($form as $forms)
                                                ...
                                                @elseif($forms['type'] === 'textarea')
                                                    <div class="input-field col {{ $forms['col'] }}">
                                                        <textarea placeholder="{{ $forms['placeholder'] }}" name="{{ $forms['name'] }}" id="{{ $forms['name'] }}"
                                                            class="validate materialize-textarea @error('nama_fakultas') is-invalid @enderror">{{ old($forms['name']) }}</textarea>
                                                ...
                                                <div class="input-field col s6">
                                                    <div class="row">
                                                        ...
                                                        <button type="button" class="row waves-effect waves-light btn-small col s9 right" onclick="getIpk()">[ Tarik IPK hasil perhitungan data transkrip mahasiswa ]</button>
                                                    </div>
                                                </div>
                                                @endif
                                            @endforeach
