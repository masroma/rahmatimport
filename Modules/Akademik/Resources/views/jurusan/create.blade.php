            ...
            @csrf
                <div class="row">
                  <div class="input-field col s12">
                    <input placeholder="Nama jurusan" name="nama_jurusan" id="nama_jurusan" type="text" class="validate  @error('nama_jurusan') is-invalid @enderror" value="{{ old('nama_jurusan') }}">
                  ...
                  <div class="input-field col s12">
                    <select name="fakultas_id" id="fakultas_id" class="validate @error('fakultas_id') is-invalid @enderror">
                        ...
                        @foreach($fakultas as $key)
                            <option  {{ old('fakultas_id') == $key->id ? 'selected' : '' }}  value="{{$key->id}}">{{$key->nama_fakultas}}</option>
                        @endforeach
                    </select>
