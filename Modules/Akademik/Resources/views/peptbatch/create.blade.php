    ...
    <div class="card-content">
      ...
      <div class="row">
            ...
            <div class="input-field col s6">
                ...
                <div class="input-field col s6">
                    <input type="text" name="nama_batch" class="validate  @error('nama_batch') is-invalid @enderror"  value="{{ old('nama_batch') }}" >
                ...
                <div class="input-field col s6">
                    <input type="date" name="tanggal_pendaftaran" class="validate  @error('tanggal_pendaftaran') is-invalid @enderror"  value="{{ old('tanggal_pendaftaran') }}" >
                ...
                <div class="input-field col s6">
                    <input type="date" name="tanggal_tutup_pendaftaran" class="validate  @error('tanggal__tutup_pendaftaran') is-invalid @enderror"  value="{{ old('tanggal_tutup_pendaftaran') }}" >
