            ...
            @csrf
                <div class="row">
                  <div class="input-field col s12">
                    <input placeholder="Tahun Ajaran" name="tahun_ajaran" id="tahun_ajaran" type="text" class="validate  @error('nama_jurusan') is-invalid @enderror" value="{{ old('tahun_ajaran') }}">
