            ...
            @csrf
                ...
                <div class="input-field col s12  mt-3 mb-3">
                    <select name="jenis_mata_kuliah" class="select2 browser-default">
                        ...
                        <option value="1" @if(old('jenis_mata_kuliah') == 1) selected @endif>Wajib Nasional</option>
                        <option value="2" @if(old('jenis_mata_kuliah') == 2) selected @endif>Wajib Program Study</option>
                        <option value="3" @if(old('jenis_mata_kuliah') == 3) selected @endif>Pilihan</option>
                        <option value="4" @if(old('jenis_mata_kuliah') == 4) selected @endif>Peminatan</option>
                        <option value="5" @if(old('jenis_mata_kuliah') == 5) selected @endif>Tugas Akhir/Skripsi/Tesis/Disertasi</option>
                      </select>
