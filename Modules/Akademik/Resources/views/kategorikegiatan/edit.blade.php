...
<div class="col s12">
  <div class="card">
    <div class="card-content">
      ...
      <div class="row">
            <form action="{{ route($page.'.update',$kategorikegiatan->id) }}" method="POST"
            ...
            @csrf
                <div class="row">
                  ...
                  <a href="{{ route('kategorikegiatan.index') }}" class="waves-effect purple darken-1 btn-small"><i class="material-icons left">keyboard_arrow_left</i>back</a>
                  </div>
                </div>
            </form>
        </div>
