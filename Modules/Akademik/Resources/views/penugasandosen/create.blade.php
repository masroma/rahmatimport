...
<div class="col s12">
  <div class="card">
    <div class="card-content">
      ...
      <div class="row">
            <form action="{{ route('penugasandosen.store') }}" method="POST"
            ...
            @csrf
                ...
                <div class="input-field col s12  mt-3 mb-3">
                    <select name="jurusan_id" class="select2 browser-default">
                        ...
                        @foreach($jurusan as $row)
                            <option @if(old('jurusan_id') == $row->id) selected @endif value="{{$row->id}}">{{$row->nama_jurusan}}</option>
                        @endforeach
                      </select>
                ...
                <div class="input-field col s12  mt-3 mb-3">
                    <select name="tahunajaran_id" class="select2 browser-default">
                        ...
                        @foreach($tahunajaran as $row)
                            <option @if(old('tahunajaran_id') == $row->id) selected @endif value="{{$row->id}}">{{$row->tahun_ajaran}}</option>
                        @endforeach
                      </select>
                ...
                <div class="input-field col s4  mt-2 mb-2">
                    <input placeholder="no surat tugas" name="no_surat_tugas" id="no_surat_tugas" type="text" class="validate  @error('no_surat_tugas') is-invalid @enderror" value="{{ old('no_surat_tugas') }}">
                  ...
                  <div class="input-field col s4  mt-2 mb-2">
                    <input placeholder="tanggal surat tugas" name="tanggal_surat_tugas" id="tanggal_surat_tugas" type="date" class="validate  @error('tanggal_surat_tugas') is-invalid @enderror" value="{{ old('tanggal_surat_tugas') }}">
                  ...
                  <div class="input-field col s4  mt-2 mb-2">
                    <input placeholder="tmt surat tugas" name="tmt_surat_tugas" id="tmt_surat_tugas" type="date" class="validate  @error('tmt_surat_tugas') is-invalid @enderror" value="{{ old('tmt_surat_tugas') }}">
