            ...
            @csrf
                <div class="row">
                  <div class="input-field col s12">
                    <input placeholder="Nama Fakultas" name="nama_fakultas" id="nama_fakultas" type="text" class="validate  @error('nama_fakultas') is-invalid @enderror" value="{{ old('nama_fakultas',$fakultas->nama_fakultas) }}">
                    <label for="first_name">Nama Fakultas</label>
                    @error('nama_fakultas')
                  ...
                  <div class="input-field col s12">
                    <input placeholder="Nama Fakultas" name="kode_fakultas" id="kode_fakultas" type="text" class="validate  @error('kode_fakultas') is-invalid @enderror" value="{{ old('kode_fakultas',$fakultas->kode_fakultas) }}">
                    <label for="first_name">Kode Fakultas</label>
                    @error('kode_fakultas')
                    <span class="red-text text-darken-2">{{ $message }}</small>
                    @enderror
                  </div>
