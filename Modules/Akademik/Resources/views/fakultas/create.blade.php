            ...
            @csrf
                <div class="row">
                  <div class="input-field col s12">
                    <input placeholder="Nama Fakultas" name="nama_fakultas" id="nama_fakultas" type="text" class="validate  @error('nama_fakultas') is-invalid @enderror" value="{{ old('nama_fakultas') }}">
                  ...
                  <div class="input-field col s12">
                    <input placeholder="Kode Fakultas" name="kode_fakultas" id="kode_fakultas" type="text" class="validate  @error('kode_fakultas') is-invalid @enderror" value="{{ old('kode_fakultas') }}">
