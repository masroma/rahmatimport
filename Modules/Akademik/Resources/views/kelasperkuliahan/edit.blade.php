                    ...
                    <div class="row">
                            ...
                            <select name="programstudy_id" class="select2 browser-default">
                                ...
                                @foreach($programstudy as $row)
                                    @foreach($row->jurusans as $r)
                                        <option @if(old('programstudy_id',$kelasperkuliahan->programstudy_id) == $row->id) selected @endif value="{{$row->id}}">
                        ...
                        <div class="input-field col s6">
                            <select name="semester_id" class="select2 browser-default">
                                ...
                                <option @if(old('semester_id',$kelasperkuliahan->semester_id) == $row->id) selected @endif value="{{$row->id}}">
