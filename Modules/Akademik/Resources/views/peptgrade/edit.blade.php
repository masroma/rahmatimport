...
<div class="col s12">
  <div class="card">
    <div class="card-content">
      ...
      <div class="row">
        <form action="{{ route($page.'.update',$peptgrade->id) }}" method="POST"
            enctype="multipart/form-data" class="col s12">
            @csrf

                <div class="input-field col s12">
                    <input type="number" name="nilai_grade" class="validate  @error('nilai_grade') is-invalid @enderror" value="{{ old('nilai_grade',$peptgrade->nilai_grade) }}"  >
                    <label for="first_name">Nilai Grade <span style="color:red">*</span></label>
                    @error('nilai_grade')
                ...
                <div class="input-field col s12">
                    <input type="text" name="tujuan" class="validate  @error('tujuan') is-invalid @enderror" value="{{ old('tujuan',$peptgrade->tujuan) }}"  >
                    <label for="first_name">Tujuan <span style="color:red">*</span></label>
                    @error('tujuan')
                    <span class="red-text text-darken-2">{{ $message }}</small>
                    @enderror
                </div>
