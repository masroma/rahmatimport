      ...
      <div class="row">
            ...
            @csrf
                ...
                <div class="input-field col s12">
                    <input type="number" name="nilai_grade" class="validate  @error('nilai_grade') is-invalid @enderror"  value="{{ old('nilai_grade') }}" >
                ...
                <div class="input-field col s12">
                    <input type="text" name="tujuan" class="validate  @error('tujuan') is-invalid @enderror"  value="{{ old('tujuan') }}" >
