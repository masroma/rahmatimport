...
<div class="col s12">
  <div class="card">
    <div class="card-content">
      ...
      <div class="row">
        <form action="{{ route('jenjangpendidikan.update',[$jenjangpendidikan->id]) }}" method="POST"
            enctype="multipart/form-data" class="col s12">
            @csrf
                <div class="row">
                  <div class="input-field col s12">
                    <input placeholder="Nama Jenjang" name="nama_jenjang" id="nama_jenjang" type="text" class="validate  @error('nama_jenjang') is-invalid @enderror" value="{{ old('nama_jenjang',$jenjangpendidikan->nama_jenjang) }}">
                    <label for="first_name">Nama Jenjang pendidikan</label>
                    @error('nama_jenjang')
