                        ...
                        <div class="col s12">
                            <div class="card">
                                <div class="card-content">
                                    ...
                                    <div class="row">
                                        <form action="{{ route('pengaturanperiodeperkuliahan.update', [$pengaturanperiodeperkuliahan->id]) }}"
                                                    ...
                                                    <div class="input-field col {{ $forms['col'] }}">
                                                        ...
                                                        <select name="{{ $forms['name'] }}" id="{{ $forms['name'] }}">
                                                            ...
                                                            @foreach ($forms['relasi'] as $p)
                                                                <option value="{{ $p->id }}" {{$p->id==$forms['data']?'selected':''}}>
                                                                    {{ $p->nama_jurusan??$p->jenis_semester.' - '.$p->Tahunajaran->tahun_ajaran }}
                                                                </option>
                                                            @endforeach
                                                        </select>
